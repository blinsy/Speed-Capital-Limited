...
public class EditAccountApiService {
     ...
     */
    public static  void editAccount(String accessToken, String url, RequestParams requestParams, AsyncHttpResponseHandler responseHandler){
        CLIENT.addHeader("Authorization","Bearer "+accessToken);
        CLIENT.put(ApiConstants.BASE_URL+url,requestParams,responseHandler);
    }
}
