...
public class GetInvoiceApplicationApiService {
     ...
     */
    public static  void GetInvoiceApplication(String accessToken, String url, RequestParams requestParams, AsyncHttpResponseHandler responseHandler){
