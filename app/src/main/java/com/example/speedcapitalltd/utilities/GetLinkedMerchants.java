...
public class GetLinkedMerchants {
     ...
     */
    public static  void getLinkedMerchants(String accessToken, String url, RequestParams requestParams, AsyncHttpResponseHandler responseHandler){
