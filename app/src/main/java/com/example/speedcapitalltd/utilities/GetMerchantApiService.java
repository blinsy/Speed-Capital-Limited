...
public class GetMerchantApiService {
     ...
     */
    public  static  void getMerchant(String accessToken, String url, RequestParams requestParams, AsyncHttpResponseHandler responseHandler)
    {
