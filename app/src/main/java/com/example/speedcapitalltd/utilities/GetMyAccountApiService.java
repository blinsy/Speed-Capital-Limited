...
public class GetMyAccountApiService {
     ...
     */
    public  static  void getAccount(String accessToken, String url, RequestParams requestParams, AsyncHttpResponseHandler responseHandler)
    {
