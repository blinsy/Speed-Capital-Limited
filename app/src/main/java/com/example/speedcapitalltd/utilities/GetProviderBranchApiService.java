...
/**
 * The type Get provider branch api service.
 */
public class GetProviderBranchApiService {
     ...
     */
    public  static  void getProviderBranch(String accessToken, String url, RequestParams requestParams, AsyncHttpResponseHandler responseHandler)
    {
