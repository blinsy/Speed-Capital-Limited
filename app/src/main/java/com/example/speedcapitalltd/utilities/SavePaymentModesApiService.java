...
/**
 * The type Save payment modes api service.
 */
public class SavePaymentModesApiService {
     ...
     */
    public  static  void savePaymentMode(String accessToken, String url, RequestParams requestParams, AsyncHttpResponseHandler responseHandler)
    {
